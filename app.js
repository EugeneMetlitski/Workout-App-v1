...
http.createServer(function(req, res) {
    ...
    if(req.method === "GET") {
        ...
        } else if(req.url === "/timemanager.html") {
            res.writeHead(200, { "Content-Type": "text/html" });
            fs.createReadStream("timemanager.html", "UTF-8").pipe(res);

        } else if(req.url === "/todo.html") {
            res.writeHead(200, { "Content-Type": "text/html" });
            fs.createReadStream("todo.html", "UTF-8").pipe(res);

        } else if(req.url === "/workout.html") {
            res.writeHead(200, { "Content-Type": "text/html" });
            fs.createReadStream("workout.html", "UTF-8").pipe(res);

        } else if(req.url === "/js/index.js") {
            res.writeHead(200, { "Content-Type": "text/html" });
            fs.createReadStream("./js/index.js", "UTF-8").pipe(res);

        } else if(req.url === "/js/timemanager.js") {
            res.writeHead(200, { "Content-Type": "text/html" });
            fs.createReadStream("./js/timemanager.js", "UTF-8").pipe(res);

        } else if(req.url === "/js/todo.js") {
            res.writeHead(200, { "Content-Type": "text/html" });
            fs.createReadStream("./js/todo.js", "UTF-8").pipe(res);

        } else if(req.url === "/js/workout.js") {
            res.writeHead(200, { "Content-Type": "text/html" });
            fs.createReadStream("./js/workout.js", "UTF-8").pipe(res);
